...
const config = {
  ...
  "inlineSchemaHash": "038fd677bdcbfeae80c9ac000930496ce2b4af79dc9705040ee1d22fd3a80e46",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/client/mongo/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/client/mongo/schema.prisma")
